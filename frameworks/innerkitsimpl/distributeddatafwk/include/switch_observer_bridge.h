...
#ifndef OHOS_DISTRIBUTED_DATA_SWITCH_OBSERVER_BRIDGE_H
...
class SwitchObserverBridge : public KvStoreDeathRecipient {
public:
    SwitchObserverBridge(const AppId &appId);
    virtual ~SwitchObserverBridge() = default;
...
private:
    ...
    inline static constexpr uint64_t INVALID_TASK_ID = static_cast<uint64_t>(0l);
