...
class ObserverBridgeMock : public BObserverBridge {
public:
    MOCK_METHOD(void, OnServiceDeath, ());
    MOCK_METHOD(Status, RegisterRemoteObserver, (uint32_t));
};
} // namespace OHOS::DistributedKv
#endif // OHOS_DISTRIBUTED_DATA_OBSERVER_BRIDGE_MOCK_H