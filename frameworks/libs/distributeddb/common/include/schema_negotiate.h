...
private:
    ...
    static bool CheckSchemaTypeAndValidity(const RelationalSchemaObject &localSchema,
        SchemaType remoteType, int &errCode);

    static bool ParseAndCheckRemoteSchema(const RelationalSchemaObject &localSchema,
