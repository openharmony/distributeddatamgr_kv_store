...
/**
 * @tc.name: ObserverDataChangeTest001
 * @tc.desc: test RegisterObserver interface with OBSERVER_CHANGES_CLOUD mode.
 * @tc.type: FUNC
 * @tc.require:
 * @tc.author: suyue
 */
HWTEST_F(DistributedDBCloudKvStoreTest, ObserverDataChangeTest001, TestSize.Level0)
{
    /**
    ...
    */
    ...
    Value actualValue;
    EXPECT_EQ(kvDelegatePtrS1_->Get(k1, actualValue), OK);
    EXPECT_EQ(actualValue, v1);
    EXPECT_EQ(kvDelegatePtrS1_->Get(k2, actualValue), OK);
    EXPECT_EQ(actualValue, v2);
    BlockSync(kvDelegatePtrS1_, OK, g_CloudSyncoption);
    ...
    */
    ...
    auto changeData = observer->GetChangedData();
    ASSERT_EQ(changeData.size(), 1u);
    EXPECT_EQ(changeData[CloudDbConstant::CLOUD_KV_TABLE_NAME].primaryData[OP_INSERT].size(), 2u);
    EXPECT_EQ(changeData[CloudDbConstant::CLOUD_KV_TABLE_NAME].primaryData[OP_UPDATE].size(), 0u);
...
/**
 * @tc.name: ObserverDataChangeTest002
 * @tc.desc: test RegisterObserver interface with OBSERVER_CHANGES_CLOUD | OBSERVER_CHANGES_BRIEF mode.
 * @tc.type: FUNC
 * @tc.require:
 * @tc.author: suyue
 */
HWTEST_F(DistributedDBCloudKvStoreTest, ObserverDataChangeTest002, TestSize.Level0)
{
    /**
     * @tc.steps: step1. insert data and delegate1 sync with cloud
     * @tc.expected: step1. insert and sync ok
    */
    Key k1 = {'k', '1'};
    Value v1 = {'v', '1'};
    ...
    */
    ...
    auto changeData = observer->GetChangedData();
    ASSERT_EQ(changeData.size(), 1u);
    EXPECT_EQ(changeData[CloudDbConstant::CLOUD_KV_TABLE_NAME].primaryData[OP_INSERT].size(), 1u);
    EXPECT_EQ(changeData[CloudDbConstant::CLOUD_KV_TABLE_NAME].primaryData[OP_UPDATE].size(), 1u);
...
/**
 * @tc.name: ObserverDataChangeTest003
 * @tc.desc: test RegisterObserver interface with err mode.
 * @tc.type: FUNC
 * @tc.require:
 * @tc.author: suyue
 */
HWTEST_F(DistributedDBCloudKvStoreTest, ObserverDataChangeTest003, TestSize.Level0)
{
    /**
...
/**
 * @tc.name: ObserverDataChangeTest004
 * @tc.desc: test register cloud observer twice
 * @tc.type: FUNC
 * @tc.require:
 * @tc.author: suyue
 */
HWTEST_F(DistributedDBCloudKvStoreTest, ObserverDataChangeTest004, TestSize.Level0)
{
    /**
