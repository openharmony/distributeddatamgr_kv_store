...
/**
 * @tc.name: KvDBManagerDeleteInstance001
 * @tc.desc: Test KvDBManager DeleteInstance
 * @tc.type: FUNC
 * @tc.author: xfz
 */
...
/**
 * @tc.name: KvDBManagerDeleteInstance002
 * @tc.desc: Test KvDBManager concurrent delete and getInstance
 * @tc.type: FUNC
 * @tc.author: xfz
 */
HWTEST_F(DistributedDBCommonTest, KvDBManagerDeleteInstance002, TestSize.Level0)
{
    ...
    std::vector<std::thread> threads;
    for (int i = 0; i < LOGGER_THREAD_COUNT_LOW; ++i) {
        if (i % LOGGER_DELETE_THREAD_RATIO == 0) {
            threads.emplace_back([]() {
                KvDBManager::DeleteInstance();
            });
...
/**
 * @tc.name: RelationalStoreInstanceDeleteInstance001
 * @tc.desc: Test RelationalStoreInstance DeleteInstance
 * @tc.type: FUNC
 * @tc.author: xfz
 */
HWTEST_F(DistributedDBCommonTest, RelationalStoreInstanceDeleteInstance001, TestSize.Level0)
{
    auto *inst = RelationalStoreInstance::GetInstance();
    ASSERT_NE(inst, nullptr);
    RelationalStoreInstance::DeleteInstance();

    auto *inst2 = RelationalStoreInstance::GetInstance();
    ASSERT_NE(inst2, nullptr);
    RelationalStoreInstance::DeleteInstance();
    RelationalStoreInstance::DeleteInstance();
}
...
/**
 * @tc.name: RelationalStoreInstanceDeleteInstance002
 * @tc.desc: Test RelationalStoreInstance concurrent delete and getInstance
 * @tc.type: FUNC
 * @tc.author: xfz
 */
HWTEST_F(DistributedDBCommonTest, RelationalStoreInstanceDeleteInstance002, TestSize.Level0)
{
    auto *inst = RelationalStoreInstance::GetInstance();
    ASSERT_NE(inst, nullptr);
    ...
    for (int i = 0; i < LOGGER_THREAD_COUNT_LOW; ++i) {
        if (i % LOGGER_DELETE_THREAD_RATIO == 0) {
            ...
            threads.emplace_back([]() {
                RelationalStoreInstance::GetInstance();
            });
        }
    }
    for (auto &thread : threads) {
...
/**
 * @tc.name: RuntimeContextDeleteInstance002
 * @tc.desc: Test RuntimeContext ConcurrentDelete And GetInstance
 * @tc.type: FUNC
 * @tc.author: xfz
 */
...
/**
 * @tc.name: RuntimeContextClean001
 * @tc.desc: Test RuntimeContext clean
 * @tc.type: FUNC
 * @tc.author: xfz
 */
HWTEST_F(DistributedDBCommonTest, RuntimeContextClean001, TestSize.Level0)
{
    ...
    property.SetStringProp(KvDBProperties::STORE_ID, "RuntimeContextClean001");
