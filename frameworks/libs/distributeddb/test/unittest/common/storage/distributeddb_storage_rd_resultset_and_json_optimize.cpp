...
class DistributedDBStorageRdResultAndJsonOptimizeTest : public testing::Test {
public:
...
void DistributedDBStorageRdResultAndJsonOptimizeTest::SetUpTestCase(void)
{
...
void DistributedDBStorageRdResultAndJsonOptimizeTest::TearDownTestCase(void)
{
...
void DistributedDBStorageRdResultAndJsonOptimizeTest::SetUp(void)
{
    DistributedDBToolsUnitTest::PrintTestCaseInfo();
    /**
     * @tc.setup: 1. Create a RdSingleVerNaturalStore.
...
{
    /**
     * @tc.teardown: Release the RdSingleVerNaturalStore.
     */
...
{
    /**
     * @tc.steps: step1. Create a RdSingleVerResultSet.
     */
    std::unique_ptr<RdSingleVerResultSet> resultSet1 =
        std::make_unique<RdSingleVerResultSet>(g_store, EMPTY_KEY);

    /**
     * @tc.steps: step2. Call RdSingleVerResultSet.Open with parameter true.
     * @tc.expected: step2. Expect return E_OK.
     */
    EXPECT_EQ(resultSet1->Open(false), E_OK);

    /**
     * @tc.steps: step3. Create a RdSingleVerResultSet.
     */
    std::unique_ptr<RdSingleVerResultSet> resultSet2 =
        std::make_unique<RdSingleVerResultSet>(g_store, EMPTY_KEY);

    /**
     * @tc.steps: step4. Call RdSingleVerResultSet.Open with parameter false.
...
HWTEST_F(DistributedDBStorageRdResultAndJsonOptimizeTest, ResultSetGetCount001, TestSize.Level1)
{
     ...
     * @tc.steps: step1. Create a RdSingleVerResultSet.
     */
    std::unique_ptr<RdSingleVerResultSet> resultSet =
        std::make_unique<RdSingleVerResultSet>(g_store, EMPTY_KEY);

    /**
     * @tc.steps: step2. Call RdSingleVerResultSet.Open
     * @tc.expected: step2. Expect return E_OK.Gits
     */
    EXPECT_EQ(resultSet->Open(false), E_OK);

    /**
     * @tc.steps: step2. Call RdSingleVerResultSet.GetCount
...
HWTEST_F(DistributedDBStorageRdResultAndJsonOptimizeTest, ResultSetGetEntry001, TestSize.Level1)
{
    ...
    /**
     * @tc.steps: step2. Call RdSingleVerResultSet MoveTo 0 And GetEntry
     * @tc.expected: step2. Expect return E_OK.
     */
    Entry entry;
...
/**
  ...
  * @tc.author: bty
  */
HWTEST_F(DistributedDBStorageRdResultAndJsonOptimizeTest, ResultSetTest002, TestSize.Level1)
{
    /**
