...
DistributedDB::DBStatus DistributedDBNbTestTools::RegisterObserver(DistributedDB::KvStoreNbDelegate &kvStoreNbDelegate,
    const DistributedDB::Key &key, unsigned int mode, const std::weak_ptr<DistributedDB::KvStoreObserver> &observer)
{
...
DistributedDB::DBStatus DistributedDBNbTestTools::UnRegisterObserver(
    DistributedDB::KvStoreNbDelegate &kvStoreNbDelegate, const std::weak_ptr<DistributedDB::KvStoreObserver> &observer)
{
