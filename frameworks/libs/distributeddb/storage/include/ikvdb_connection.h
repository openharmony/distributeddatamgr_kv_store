...
public:
    ...
    virtual int RegisterObserverAction(std::shared_ptr<KvStoreObserver> observer,
        const ObserverAction &action) = 0;

    virtual int UnRegisterObserverAction(std::shared_ptr<KvStoreObserver> observer) = 0;
