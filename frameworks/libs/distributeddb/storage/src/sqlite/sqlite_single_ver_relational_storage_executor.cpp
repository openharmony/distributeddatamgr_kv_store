...
{
    std::string devName = DBCommon::TransferStringToHex(DBCommon::TransferHashString(deviceName));
    const std::string tableName = DBConstant::RELATIONAL_PREFIX + object.GetTableName() + "_log";
    std::string dataFormat = "?, '" + devName + "', ?, ?, ?, ?, ?";
...
{
    item.dev = DBCommon::TransferStringToHex(DBCommon::TransferHashString(deviceName));
