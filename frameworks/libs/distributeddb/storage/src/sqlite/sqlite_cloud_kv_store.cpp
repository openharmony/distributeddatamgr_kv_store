...
void SqliteCloudKvStore::RegisterObserverAction(const std::weak_ptr<KvStoreObserver> &observer,
...
void SqliteCloudKvStore::UnRegisterObserverAction(const std::weak_ptr<KvStoreObserver> &observer)
{
    std::lock_guard<std::mutex> autoLock(observerMapMutex_);
