...
public:
    ...
    static int GetCloudVersionFromCloud(sqlite3 *db, bool isMemory, const std::string &device,
...
private:
    ...
    static int BindVersionStmt(const std::string &device, sqlite3_stmt *dataStmt);
