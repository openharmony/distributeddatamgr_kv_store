...
public:
    ...
    int RegisterObserverAction(const std::weak_ptr<KvStoreObserver> &observer, const ObserverAction &action) override;

    int UnRegisterObserverAction(const std::weak_ptr<KvStoreObserver> &observer) override;
