...
int GenericKvDBConnection::RegisterObserverAction([[gnu::unused]] std::shared_ptr<KvStoreObserver> observer,
    [[gnu::unused]] const ObserverAction &action)
{
    return E_OK;
}

int GenericKvDBConnection::UnRegisterObserverAction([[gnu::unused]] std::shared_ptr<KvStoreObserver> observer)
{
    return E_OK;
}
