...
#ifndef DISTRIBUTED_KVSTORE_MOCK_REMOTE_BROKER_H
#define DISTRIBUTED_KVSTORE_MOCK_REMOTE_BROKER_H
...
public:
    ...
    sptr<IRemoteBroker> operator()(const sptr<IRemoteObject>& object)
    {
        ...
        if (proxy != nullptr) {
            return sptr<IRemoteBroker>(static_cast<IRemoteBroker*>(proxy));
        }
        return nullptr;
    };
};
...
#endif // DISTRIBUTED_KVSTORE_MOCK_REMOTE_BROKER_H
