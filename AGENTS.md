...
1. 需要改某个模块，只读知识路由表中匹配的那一个文档，不要全读。
2. 如果影响范围不清楚，读取 `docs/agents/architecture.md` 和 `docs/agents/code-map.md`。
...
## 验证习惯
涉及代码修改时，读取 `docs/agents/build-and-test.md`，选择单元测试目标，进行完整单元运行测试。
